            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="{{ route('laporan.tahun.result') }}" method="POST">
                        	{!! csrf_field() !!}
                            <div class="form-body">
                            	<div class="row">
                            		<div class="col-md-4">
	                            		<h5 class="m-t-30 m-b-10">Pilih Tahun</h5>
	                                        
	                                    <select class="select2 form-control custom-select" name="tahun" style="width: 100%; height:36px;" required>
		                                    <option> </option>
		                                    @foreach ($tahun as $key => $value)
		                                    	<option value="{{ $value->AKADEMIK }}" {{ isset($request) ? ($request['tahun'] == $value['AKADEMIK']) ? "selected" : "" : "" }}> {{ $value->AKADEMIK }}</option>
		                                    @endforeach
		                                </select>
		                            </div>
                                </div>
	                    ...
	                    <div class="card">
	                        <div class="card-body">
	                        	@if ($result)
	                        		...
	                        		<form role="form" target="_blank" action="{{ route('laporan.tahun.print') }}" method="GET">
			                        	{!! csrf_field() !!}
			                            <div class="form-body">
			                                <div class="row">
