            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="{{ route('laporan.angkatan.result') }}" method="POST">
                        	{!! csrf_field() !!}
                            <div class="form-body">
                            	<div class="row">
                            		<div class="col-md-6">
                                        <h5 class="m-t-30 m-b-10">Angkatan</h5>
                                        <input type="text" id="angkatan" name="angkatan" class="form-control" placeholder="Angkatan" value="{{ isset($request['angkatan']) ? $request['angkatan'] : ''  }}">
                                    </div>
                                </div>
                            	<div class="row">
                                    <div class="col-md-4">
	                    ...
	                    <div class="card">
	                        <div class="card-body">
	                        	@if ($result)
	                        		...
	                        		<form role="form" target="_blank" action="{{ route('laporan.angkatan.print') }}" method="GET">
			                        	{!! csrf_field() !!}
			                            <div class="form-body">
			                                <div class="row">
